...
function lists() {
    ...
    foreach ($list in $lists) {
        ...
        $o | Add-Member -MemberType noteproperty -Name "Web Title" -value $currentWeb.Title;
        $o | Add-Member -MemberType noteproperty -Name "Web url" -value $currentWeb.ServerRelativeUrl;
        $o | Add-Member -MemberType noteproperty -Name "Web creation date" -value $currentWeb.Created;
        $o | Add-Member -MemberType noteproperty -Name "Web last item modified" -value $currentWeb.LastItemModifiedDate;
        $o | Add-Member -MemberType noteproperty -Name "List name" -value $list.Title;
        $o | Add-Member -MemberType noteproperty -Name "List BaseType" -value $list.BaseType;
        $o | Add-Member -MemberType noteproperty -Name "List BaseTemplate" -value $list.BaseTemplate;
        $o | Add-Member -MemberType noteproperty -Name "List DefaultViewUrl" -value $baseUrl$($list.DefaultViewUrl)
        $o | Add-Member -MemberType noteproperty -Name "List ItemCount" -value $list.ItemCount;
        $o | Add-Member -MemberType noteproperty -Name "List LastItemModifiedDate" -value $list.LastItemModifiedDate;
        $output += $o;
    }
...
function listItems() {
    ...
    foreach ($list in $lists) {
        ...
        foreach ($listItem in $listItems) {
            ...
            # only execute if versions are to be analyzed, because this is a timeconsuming operation
